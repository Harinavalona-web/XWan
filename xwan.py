#!/usr/bin/env python3
#xwan v.3.0 use xray core v25.12.8
import os
...
def main():
    ...
    check.check_core()
    helpers.show_menu()
    choice = input(f"{Fore.YELLOW}[*] Pilih metode (1-7): {Style.RESET_ALL}").strip()
    ...
    print(f"{Fore.CYAN}[!] Result CONNECTED in : Result.txt{Style.RESET_ALL}")
